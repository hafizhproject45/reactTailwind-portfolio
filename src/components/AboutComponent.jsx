        ...
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-10 lg:w-1/2">
            ...
            <p className="font-medium text-base text-secondary max-w-xl lg:text-lg">
              ...
              dignissimos ea cumque aspernatur asperiores alias maiores,
              reprehenderit sunt odit nisi.
            </p>
          </div>
          <div className="w-full px-4 lg:w-1/2">
            ...
            <p className="font-medium text-base text-secondary mb-6 lg:text-lg">
              ...
              eligendi vero nesciunt ipsam saepe dolorem deserunt doloribus
              excepturi itaque dolor.
            </p>
            <div className="flex items-center">
              {/* Youtube */}
              <a
                href="https://instagram.com/hafizh.png"
                target="_blank"
                rel="noreferrer"
              ...
              >
                <svg
                  ...
                  className="fill-current" //agar menjadi text
                >
